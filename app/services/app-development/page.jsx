...
import { Smartphone, CheckCircle2, MessageSquare, ArrowLeft } from "lucide-react";
import Link from "next/link";

export default function AppDevelopmentPage() {
  const techStack = ["React Native", "Cross-Platform", "App Store Optimization"];
  const bulletPoints = [
    "Pristine Global State Management Frameworks",
    "Unified Cross-Platform Core Single Codebase Outputs",
    "Native Render Speeds for iOS and Android Systems",
    "Fully Streamlined Deployment Lifecycle Optimization"
  ];

  const triggerWhatsApp = () => {
    const msg = encodeURIComponent("Hi Wepzite! I want to inquire about a strategy for Native App Development.");
      ...
      <div className="w-full max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-6">
            <span className="text-[10px] font-black tracking-widest text-sky-600 bg-sky-50 px-3 py-1 rounded-full uppercase border border-sky-100">Multi-Platform</span>
            <h1 className="text-3xl sm:text-5xl font-black text-slate-900 uppercase tracking-tight leading-none">Native App Development</h1>
            <p className="text-slate-500 text-sm sm:text-base font-medium normal-case leading-relaxed">
              Fluid, high-performance mobile applications engineered with pristine state management. Expand your brand footprint natively onto your clients' personal screens.
            </p>
          ...
          <div className="lg:col-span-5">
            <div className="w-full aspect-square rounded-3xl overflow-hidden border border-sky-100 bg-slate-50 p-4 shadow-sm">
              <img src="image_agent_tag_17038675738162254843" alt="Mobile App UI Development Workflow" className="w-full h-full object-cover rounded-2xl" />
            </div>
          </div>
        </div>
      </div>
